...
class NC_Projet_List extends WP_List_Table {
    ...
    public function get_columns($columns = array()) {
        ...
        global $wpdb;        
        $db_first = $wpdb->prefix . NC_PROJET_BASENAME .'_subscribers';
        $db_second = $wpdb->prefix . NC_PROJET_BASENAME .'_subscribersdata';
    ...
    public function table_data($per_page=10, $page_number=1, $orderbydefault=false) {
        ...
        $db_first = $wpdb->prefix . NC_PROJET_BASENAME .'_voyages';
